...
public class TaskAdapter extends RecyclerView.Adapter<TaskAdapter.TaskViewHolder> {
    ...
    private static final String datetext = "dd/MM/yyy";
    ...
    // Date formatter
    private SimpleDateFormat dateText = new SimpleDateFormat(datetext, Locale.getDefault());
    ...
    public void onBindViewHolder(TaskViewHolder holder, int position) {
        ...
        String updatedAt = dateText.format(taskEntry.getUpdatedAt());
